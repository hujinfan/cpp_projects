...
public:
	...
	LightRightCom(char *abc){cout<<"LightRightCom(char *abc)"<<endl;}
};
...
class LightRightSofaBed : public SofaBed, virtual public LightRightCom{
private:
	Date date;
	Type type;
public:
	LightRightSofaBed(){cout<<"LightRightSofaBed()"<<endl;}
	LightRightSofaBed(char *str1, char *str2, char *str3) 
		: SofaBed(str1),LightRightCom(str2),date(str3)
	{
		cout<<"LightRightSofaBed()"<<endl;
	}
};

int main(int argc, char **argv)
{
	LightRightSofaBed s("abc", "2323", "yyy");
